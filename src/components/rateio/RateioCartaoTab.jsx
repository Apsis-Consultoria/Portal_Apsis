...
export default function RateioCartaoTab({ onProcessed }) {
    ...
    try {
      ...
      for (const lancamento of lancamentos) {
        await base44.entities.RateioLancamento.create({
          ...
          tipo_despesa: lancamento.categoria || "cartão corporativo",
          reembolsavel: false,
        ...
        <Card className="p-8 border-2 border-dashed border-[var(--border)] bg-[var(--surface-2)]">
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-[var(--text-primary)] mb-2">
              Envie a fatura ou extrato do Cartão de Crédito
            </p>
            <p className="text-xs text-[var(--text-secondary)] mb-6">
              Suporte: planilha (XLSX, CSV) ou PDF
            </p>
